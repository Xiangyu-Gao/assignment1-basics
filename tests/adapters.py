...
def run_linear(
    ...
    """
    # Initialize a Linear layer with the given input and output dimensions
...
def run_embedding(
    ...
    # Initialize an Embedding layer with the given vocabulary size and embedding dimension
...
def run_multihead_self_attention(
    ...
    # Load the weights into the multi-head attention module
    ...
    return multihead_attention.forward(in_features, use_rope=False)
...
def run_multihead_self_attention_with_rope(
    ...
    return multihead_attention.forward(in_features, use_rope=True)
...
def run_transformer_lm(
    ...
    # Load the weights into the transformer LM
    state_dict = {
    ...
    for i in range(num_layers):
        state_dict.update({
            f"transformer_blocks.{i}.mha.W_Q.weight": weights[f"layers.{i}.attn.q_proj.weight"],
            f"transformer_blocks.{i}.mha.W_K.weight": weights[f"layers.{i}.attn.k_proj.weight"],
            f"transformer_blocks.{i}.mha.W_V.weight": weights[f"layers.{i}.attn.v_proj.weight"],
            f"transformer_blocks.{i}.mha.W_O.weight": weights[f"layers.{i}.attn.output_proj.weight"],
            f"transformer_blocks.{i}.norm1.weight": weights[f"layers.{i}.ln1.weight"],
            ...
            f"transformer_blocks.{i}.norm2.weight": weights[f"layers.{i}.ln2.weight"],
        })
...
def run_rmsnorm(
    ...
    # Load the weights into the RMSNorm layer
